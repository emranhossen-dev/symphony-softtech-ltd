  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-gray-300 mt-1">Manage your personal information and view your teaching statistics.</p>
      </div>
        ...
        <div className="px-6 pb-6">
          <div className="flex items-end -mt-12 mb-4">
            ...
            <div className="ml-4 mb-2">
              <h2 className="text-2xl font-bold text-white">{mentorInfo.name}</h2>
              <p className="text-gray-300">{mentorInfo.specialization}</p>
            </div>
            ...
            <div>
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-gray-300">{mentorInfo.email}</span>
                </div>
                <div className="flex items-center gap-3">
                  <Phone className="w-5 h-5 text-gray-400" />
                  <span className="text-gray-300">{mentorInfo.phone}</span>
                </div>
                <div className="flex items-center gap-3">
                  <MapPin className="w-5 h-5 text-gray-400" />
                  <span className="text-gray-300">{mentorInfo.location}</span>
                </div>
                <div className="flex items-center gap-3">
                  <Calendar className="w-5 h-5 text-gray-400" />
                  <span className="text-gray-300">Joined {mentorInfo.joinDate}</span>
                </div>
              </div>
            </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        <div className="glass-card p-6 text-center">
          ...
          <div className="text-2xl font-bold text-white">{mentorInfo.stats.coursesTaught}</div>
          <div className="text-sm text-gray-300">Courses Taught</div>
        </div>
        <div className="glass-card p-6 text-center">
          <User className="w-8 h-8 text-green-400 mx-auto mb-3" />
          <div className="text-2xl font-bold text-white">{mentorInfo.stats.studentsMentored}</div>
          <div className="text-sm text-gray-300">Students Mentored</div>
        </div>
        <div className="glass-card p-6 text-center">
          <Award className="w-8 h-8 text-yellow-400 mx-auto mb-3" />
          <div className="text-2xl font-bold text-white">{mentorInfo.stats.averageRating}</div>
          <div className="text-sm text-gray-300">Average Rating</div>
        </div>
        <div className="glass-card p-6 text-center">
          <Calendar className="w-8 h-8 text-purple-400 mx-auto mb-3" />
          <div className="text-2xl font-bold text-white">{mentorInfo.stats.totalHours}</div>
          <div className="text-sm text-gray-300">Teaching Hours</div>
        </div>
      </div>
