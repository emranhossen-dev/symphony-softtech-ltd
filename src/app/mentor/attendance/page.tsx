  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-gray-300 mt-1">Mark and track student attendance for your courses.</p>
      </div>
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-6 pt-6">
            ...
            <div className="text-center">
              ...
              <div className="text-sm text-gray-300">Not Marked</div>
            </div>
          </div>
        </div>
      </div>
      ...
      {courseStudents.length === 0 && (
        <div className="glass-card p-12 text-center">
          ...
          <p className="text-gray-300">This course doesn't have any enrolled students.</p>
        </div>
      )}
    </div>
  );
