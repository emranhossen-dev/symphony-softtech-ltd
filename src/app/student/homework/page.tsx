  ...
  const submissions: HomeworkSubmission[] = [
    {
      ...
      status: 'approved',
      grade: 85,
      feedback: 'Great work on the portfolio structure! Consider improving responsive design.'
    },
    {
      id: '2',
    ...
    },
    {
      ...
      status: 'rejected',
      grade: 65,
      feedback: 'Components need better documentation and some functionality is missing.'
    },
    {
      id: '5',
